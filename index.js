...
const varifyJWT = (req, res, next) => {
    ...
    console.log('token inside varified jwt', token);
...
async function run() {
    try {
        ...
        app.get('/bookings', varifyJWT, async(req, res) => {
            ...
            console.log('have been out of varifyJWT', decoded);
...
app.listen(port, () => console.log(`cars-doctor server is running on PORT: ${port}`))
